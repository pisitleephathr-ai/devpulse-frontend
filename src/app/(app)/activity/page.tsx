...
const ACTION_META: Record<string, { label: string; color: string }> = {
  ...
  "leave.create": { label: "แจ้งติดธุระ", color: "#0d9488" },
  "leave.cancel": { label: "ยกเลิกติดธุระ", color: "#a1a1aa" },
  "leave.delete": { label: "ลบรายการติดธุระ", color: "#e11d48" },
...
const ENTITY_META: Record<string, { label: string; color: string }> = {
  ...
  leave: { label: "ติดธุระ", color: "#0d9488" },
